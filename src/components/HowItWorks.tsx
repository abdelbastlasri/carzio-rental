    ...
    <section id="about" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-white font-heading text-3xl md:text-4xl font-bold mb-3 tracking-tight">{t('howItWorks.title')}</h2>
        ...
        >
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <h3 className="text-white font-heading font-semibold text-lg mb-2 tracking-tight">{t(step.title)}</h3>
              <p className="text-white/50 text-sm leading-relaxed max-w-xs mx-auto">{t(step.description)}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
