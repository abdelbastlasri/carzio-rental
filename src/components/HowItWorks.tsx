...
export default function HowItWorks() {
  return (
    <section id="about" className="bg-zinc-900 py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-white font-heading text-3xl md:text-4xl font-bold mb-3">Quick &amp; Easy Car Rental</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step) => (
            <div key={step.number} className="text-center relative group">
              <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-gold/20 transition border border-gold/20 group-hover:border-gold/40">
                <span className="text-gold font-heading font-bold text-2xl">{step.number}</span>
              </div>
              <h3 className="text-white font-heading font-semibold text-lg mb-2">{step.title}</h3>
