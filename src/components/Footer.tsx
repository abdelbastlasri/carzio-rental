        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/40 text-sm">
              ...
              <li>
                <a
                  ...
                  className="hover:text-gold transition text-xs"
                >
                  {t('footer.openInMaps')}
                </a>
              </li>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-white/10 transition" aria-label="Facebook">
                <svg className="w-4 h-4 text-white/60 hover:text-gold transition" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/carzio_cars?igsh=bjl5OWx2MmMxY21z&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-white/10 transition" aria-label="Instagram">
                <svg className="w-4 h-4 text-white/60 hover:text-gold transition" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-white/10 transition" aria-label="LinkedIn">
                <svg className="w-4 h-4 text-white/60 hover:text-gold transition" fill="currentColor" viewBox="0 0 24 24">
